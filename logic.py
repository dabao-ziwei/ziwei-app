...
class ZWDSCalculator:
    ...
    def _calc_shen_sha(self):
        ...
        for i, name in enumerate(jiang_names):
            pos = (start + i) % 12
            self.palaces[pos]["jiang_12"].append(name)
